...
export class CoursesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // when you sending parameters like page and order you are mostly will come back to the same 
    ...
    // combineLatest takes an array of observables
    let obs = combineLatest([
      ...
      .subscribe(combined => {
        ...
        // what if we have another subscribe here to the service to get a list with a page and order
        // the code will be ugly see the video 136 to fix this with map and map switch
